...
export const CarouselCollaboration = (props) => {
    ...
    return (
        <Row>
            <Col md={12}>
                <Carousel wrap={true} interval={null} defaultActiveIndex={subDimensions === 31 ? 0 : subDimensions === 32 ? 1 : subDimensions === 33 ? 2 : ""}>
                    <Carousel.Item>
                            ...
                            <Col md={5}>
                                <Card border="0" >
                                    <Card.Body className="borde-left interpretation-card">
                                        ...
                                        <a onClick={() => { props.goBack(3) }} className="color-orange-one"><b><i className="fas fa-chevron-left"></i></b> {t("return_to_main_graph")}</a>
                                    </Card.Body>
                                </Card>
                            </Col>
                        </Row>
