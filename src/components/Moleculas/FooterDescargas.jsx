        ...
        <>
            <div className="contenedor-first-footer">
                <div className="contenedor">
                    ...
                    <div className="lista">
                        <ul>
                            <li><i className="fas fa-chevron-right color-orange-one"></i> <a href="/Nota_Técnica_Indice_Innovación_Pública.pdf" target="_blank" className="color-orange-one"> <span className="underline">{t("technical_note_of_results")}</span> <span>(.pdf)</span> </a></li>
